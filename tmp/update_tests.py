...
content = """# 118+ Smoke & E2E Tests Execution Plan
We will run these tests one by one, starting from the hardest / longest flows (Complete Transaction Cycle, Beta Squad scenarios, etc.) to the normal/lighter tests (Accessibility, Smoke, Web Vitals).

## Hardest / Complex Flows
...
## Newly Added (Phase 6-10 Features)
- [ ] [tests/e2e/ai-flows.spec.ts](file:///c:/Users/hp/Documents/DoDo/tests/e2e/ai-flows.spec.ts)
- [ ] [tests/e2e/authorization-security.spec.ts](file:///c:/Users/hp/Documents/DoDo/tests/e2e/authorization-security.spec.ts)
- [ ] [tests/e2e/pwa-offline.spec.ts](file:///c:/Users/hp/Documents/DoDo/tests/e2e/pwa-offline.spec.ts)
...
## Moderate Flows & Standard Features
...
## Performance & Accessibility (Normal/Easiest to run individually)
...
with open(r"c:\Users\hp\.gemini\antigravity\brain\7c5ebad1-7d70-407d-8de5-39c1161f6cca\task.md.resolved", "w", encoding="utf-8") as f:
    f.write(content)
print("Execution Plan Updated Successfully")
