...
const statusConfig = {
    'Open for Bidding': {
        description: 'Professionals can submit bids until the deadline',
    ...
    'Awarded': {
        description: 'Job awarded to Professional, awaiting acceptance',
        nextStep: 'Professional must accept within deadline',
    ...
    'Pending Funding': {
        description: 'Professional accepted, payment required',
    ...
    'Pending Confirmation': {
        description: 'Professional submitted work for review',
    ...
    'Completed': {
        ...
        nextStep: 'Leave a review for the Professional',
