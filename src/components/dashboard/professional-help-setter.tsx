...
export function ProfessionalHelpSetter({ isVerified }: { isVerified?: boolean; }) {
    const { setHelp } = useHelp();

    useEffect(() => {
        setHelp({
            title: 'Professional Dashboard Guide',
            content: (
                <div className="space-y-4 text-sm">
                    ...
                    <ul className="list-disc space-y-2 pl-5">
                        ...
                        {!isVerified && (
                            <li>
                                <span className="font-semibold">Verification:</span> Complete your Aadhar verification to become a trusted service provider and increase your chances of winning jobs.
                            </li>
                        )}
                        <li>
