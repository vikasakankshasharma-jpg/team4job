import { fetchTransactions, fetchClientStats } from "@/app/actions/dashboard-data.actions";
import { format, subMonths } from "date-fns";
import { toDate } from "@/lib/utils";
import { ClientChartsClient } from "./client-charts-client";

export async function ClientChartsWidget({ userId }: { userId: string }) {
