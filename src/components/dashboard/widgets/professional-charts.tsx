...
import { ProfessionalChartsClient } from "./professional-charts-client";

export async function ProfessionalChartsWidget({ userId }: { userId: string }) {
