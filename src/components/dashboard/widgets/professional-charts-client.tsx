...
interface ProfessionalChartsClientProps {
    earningsData: any[];
    totalEarnings: number;
    pendingPayments: number;
}

export function ProfessionalChartsClient({ earningsData, totalEarnings, pendingPayments }: ProfessionalChartsClientProps) {
    return (
