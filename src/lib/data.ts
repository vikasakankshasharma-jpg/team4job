...
export const users: User[] = [
  {
    ...
    address: { house: '123 Admin Lane', street: 'Governance Road', cityPincode: '110001', fullAddress: '123 Admin Lane, Governance Road, 110001' },
    roles: ['Admin'],
  ...
  },
  {
    ...
    pincodes: { residential: '110001', office: '110021' },
    address: { house: 'A-1, Connaught Place', street: 'Inner Circle', cityPincode: '110001, Parliament Street', fullAddress: 'A-1, Connaught Place, Inner Circle, 110001, Parliament Street' },
  ...
  },
  {
    ...
    pincodes: { residential: '400001' },
    address: { house: 'Building 5, Marine Drive', street: 'Kalbadevi', cityPincode: '400001, Kalbadevi', fullAddress: 'Building 5, Marine Drive, Kalbadevi, 400001, Kalbadevi' },
    roles: ['Job Giver'],
  ...
  },
  {
    ...
    pincodes: { residential: '500001' },
    address: { house: 'H.No. 42, Begumpet', street: 'G.P.O. Road', cityPincode: '500001, Hyderabad G.P.O.', fullAddress: 'H.No. 42, Begumpet, G.P.O. Road, 500001, Hyderabad G.P.O.' },
    roles: ['Installer'],
  ...
  },
  {
    ...
    pincodes: { residential: '600001' },
    address: { house: '7 Anna Salai', street: 'Chennai GPO Area', cityPincode: '600001, Chennai G.P.O.', fullAddress: '7 Anna Salai, Chennai GPO Area, 600001, Chennai G.P.O.' },
    roles: ['Installer'],
  ...
  },
  {
    ...
    pincodes: { residential: '110031' },
    address: { house: 'Flat 101, Secret Towers', street: 'AGCR Colony', cityPincode: '110031, A.G.C.R.', fullAddress: 'Flat 101, Secret Towers, AGCR Colony, 110031, A.G.C.R.' },
    roles: ['Installer'],
  ...
  },
  {
    ...
    pincodes: { residential: '400050' },
    address: { house: 'Sea View Apt, Carter Road', street: 'Bandra West', cityPincode: '400050, Bandra West', fullAddress: 'Sea View Apt, Carter Road, Bandra West, 400050, Bandra West' },
    roles: ['Job Giver'],
  ...
  },
  {
    ...
    pincodes: { residential: '800001' },
    address: { house: 'Fraser Road', street: 'Bankipore', cityPincode: '800001, Bankipore', fullAddress: 'Fraser Road, Bankipore, 800001, Bankipore' },
    roles: ['Installer'],
  ...
  },
  {
    ...
    pincodes: { residential: '500032' },
    address: { house: 'Ameerpet', street: 'Sanjeev Reddy Nagar', cityPincode: '500032, S.R.Nagar', fullAddress: 'Ameerpet, Sanjeev Reddy Nagar, 500032, S.R.Nagar' },
    roles: ['Job Giver', 'Installer'],
  ...
  },
  {
    ...
    address: { house: 'MG Road', street: 'Bangalore GPO', cityPincode: '560001, Bangalore G.P.O.', fullAddress: 'MG Road, Bangalore GPO, 560001, Bangalore G.P.O.' },
    roles: ['Job Giver'],
  ...
  },
  {
    ...
    pincodes: { residential: '700001' },
    address: { house: 'Park Street', street: 'Kolkata GPO', cityPincode: '700001, Kolkata G.P.O.', fullAddress: 'Park Street, Kolkata GPO, 700001, Kolkata G.P.O.' },
    roles: ['Installer'],
...
export const jobs: Job[] = [
  {
    ...
    bidderIds: ['USER-20220815-ALEXJ', 'INSTALLER-20230510-CARL', 'INSTALLER-20211111-ETHA'],
    comments: [
      {
        id: 'comment-1-1',
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20230120-BREN'),
    location: '600001',
    address: { house: '15, 3rd Main Road', street: 'Besant Nagar', cityPincode: '600090, Besant Nagar', fullAddress: '15, 3rd Main Road, Besant Nagar, Chennai, Tamil Nadu 600090'},
    ...
    bidderIds: ['INSTALLER-20230510-CARL'],
    comments: [],
    privateMessages: [
        {
            id: 'pm-3-1',
  ...
  },
  {
    ...
    jobGiver: findUser('USER-20220815-ALEXJ'),
    location: '500001',
    address: { house: 'Plot 42, Jubilee Hills', street: 'Hyderabad', cityPincode: '500033, Jubilee Hills', fullAddress: 'Plot 42, Jubilee Hills, Hyderabad, Telangana 500033' },
  ...
  },
  {
    ...
    location: '400050',
    address: { house: 'Unit 5, Shakti Logistics Park', street: 'Bhiwandi', cityPincode: '421302, Bhiwandi', fullAddress: 'Unit 5, Shakti Logistics Park, Bhiwandi, Thane, Maharashtra 421302' },
    ...
    bidderIds: ['INSTALLER-20211111-ETHA', 'INSTALLER-20230801-GEOR'],
    comments: [
      {
        id: 'comment-5-1',
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20230120-BREN'),
    location: '800001',
    address: { house: 'Near NH31', street: 'Bihta', cityPincode: '801103, Bihta', fullAddress: 'Near NH31, Bihta, Patna, Bihar 801103' },
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20220430-FION'),
    location: '110001',
    address: { house: 'DLF Crest, Sector 54', street: 'Gurugram', cityPincode: '122011, Gurugram', fullAddress: 'DLF Crest, Sector 54, Gurugram, Haryana 122011' },
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20220430-FION'),
    location: '400050',
    address: { house: 'Villa 23, Hiranandani Gardens', street: 'Powai', cityPincode: '400076, Powai', fullAddress: 'Villa 23, Hiranandani Gardens, Powai, Mumbai, Maharashtra 400076' },
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20220430-FION'),
    location: '500032',
    address: { house: 'Cyber Towers, HITEC City', street: 'Hyderabad', cityPincode: '500081, HITEC City', fullAddress: 'Cyber Towers, HITEC City, Hyderabad, Telangana 500081' },
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20230120-BREN'),
    location: '110001',
    address: { house: 'Modern School, Barakhamba Road', street: 'New Delhi', cityPincode: '110001, Barakhamba', fullAddress: 'Modern School, Barakhamba Road, New Delhi, Delhi 110001' },
  ...
  },
  {
    ...
    jobGiver: findUser('USER-20220815-ALEXJ'),
    location: '500001',
    address: { house: 'Gachibowli Financial District, Nanakramguda', street: 'Hyderabad', cityPincode: '500032, Gachibowli', fullAddress: 'Gachibowli Financial District, Nanakramguda, Hyderabad, Telangana 500032' },
    ...
    bidderIds: ['USER-20220815-ALEXJ', 'INSTALLER-20230510-CARL'],
    comments: [
      {
        id: 'comment-12-1',
        author: findUser('USER-20220815-ALEXJ'),
  ...
  },
  {
    ...
    jobGiver: findUser('USER-20240110-HANN'),
    location: '500032',
    address: { house: 'My Home Bhooja, Raidurg', street: 'Hyderabad', cityPincode: '500081, Raidurg', fullAddress: 'My Home Bhooja, Raidurg, Hyderabad, Telangana 500081' },
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20230120-BREN'),
    location: '600001',
    address: { house: 'Amethyst Cafe, Whites Road', street: 'Royapettah', cityPincode: '600014, Royapettah', fullAddress: 'Amethyst Cafe, Whites Road, Royapettah, Chennai, Tamil Nadu 600014' },
  ...
  },
  {
    ...
    jobGiver: findUser('JOBGIVER-20220430-FION'),
    location: '800001',
    address: { house: 'Fraser Road Area', street: 'Patna', cityPincode: '800001, Patna', fullAddress: 'Fraser Road Area, Patna, Bihar 800001' },
    ...
    bidderIds: ['INSTALLER-20230801-GEOR'],
    comments: [],
...
export const disputes: Dispute[] = [
    {
        ...
        requesterId: 'JOBGIVER-20220430-FION',
        category: 'Job Dispute',
        jobTitle: 'Apartment Complex Access Control & CCTV',
        title: "Installer using incorrect camera brand",
        status: 'Open',
    ...
    {
        id: 'DISPUTE-002',
        requesterId: 'USER-20220815-ALEXJ',
        jobId: 'JOB-20240825-4D6E',
        category: 'Job Dispute',
        jobTitle: 'Maintenance and Check-up for existing system',
        title: "Installer claims job is complete, but cameras are offline",
        status: 'Resolved',
