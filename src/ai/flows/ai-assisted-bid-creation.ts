...
/**
 * @fileOverview An AI-powered assistant for Professionals to craft effective bids.
 *
...
const AiAssistedBidCreationInputSchema = z.object({
  ...
  professionalSkills: z.string().describe('The skills of the professional.'),
  professionalExperience: z.string().describe('The experience level of the professional.'),
...
const bidCreationPrompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant helping a skilled Professional create a professional and effective bid for a job. The platform keeps bidders anonymous until a job is awarded.

  **Task**: Generate a compelling and well-organized bid proposal that highlights the professional's strengths and suitability for the job, while maintaining their anonymity.
  ...
  **Instructions**:
  ...
  4.  **Maintain Anonymity:** Do not use a real name in the signature. Sign off with a professional but generic closing like "Sincerely, A Skilled Professional" or "Respectfully,".
  5.  **Be Professional:** Do not use placeholders like '[Client Name]'. The tone should be confident and persuasive.

  **Job Description**: {{{jobDescription}}}
  **Professional Profile**: {{{professionalSkills}}}, with experience of: {{{professionalExperience}}}
