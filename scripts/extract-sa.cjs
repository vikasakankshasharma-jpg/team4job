...
if (keyMatch) {
  ...
  fs.writeFileSync('src/lib/firebase/service-account.json', JSON.stringify(account, null, 2));
  console.log('Saved src/lib/firebase/service-account.json successfully');
} else {
