...
exports.onJobCreated = functions.firestore
    ...
    for (const doc of searchesSnap.docs) {
        ...
        let match = true;
        // Min Price
        if (criteria.minPrice && (((_a = job.budget) === null || _a === void 0 ? void 0 : _a.min) || 0) < criteria.minPrice)
            match = false;
        ...
        if (criteria.maxPrice && (((_b = job.budget) === null || _b === void 0 ? void 0 : _b.min) || 0) > criteria.maxPrice)
            match = false;
        ...
        if (match && criteria.skills && criteria.skills.length > 0) {
            ...
            const searchSkills = criteria.skills.map((s) => s.toLowerCase());
            const intersection = jobSkills.filter((s) => searchSkills.includes(s));
        ...
        if (match && criteria.location) {
            ...
            if (!((_c = job.location) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes(criteria.location.toLowerCase())) &&
                !((_d = job.fullAddress) === null || _d === void 0 ? void 0 : _d.toLowerCase().includes(criteria.location.toLowerCase()))) {
                match = false;
            }
        }
        ...
        if (match && criteria.query) {
            ...
            if (!job.title.toLowerCase().includes(q) && !((_e = job.description) === null || _e === void 0 ? void 0 : _e.toLowerCase().includes(q))) {
                match = false;
            }
        }
        if (match) {
                    ...
                    const html = `
                            <div style="font-family: sans-serif; color: #333;">
                                ...
                                <div style="border: 1px solid #eee; padding: 15px; border-radius: 8px; margin: 20px 0;">
                                    ...
                                    <p><strong>Budget:</strong> ₹${(_h = job.budget) === null || _h === void 0 ? void 0 : _h.min} - ₹${(_j = job.budget) === null || _j === void 0 ? void 0 : _j.max}</p>
