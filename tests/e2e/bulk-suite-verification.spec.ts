...
test.describe('Bulk Job Suite & AI Features Verification @bulk-ai', () => {
    ...
    test('Verify CCTV Page Tabs and AI Smart Split', async ({ page }) => {
        ...
        await expect(textarea).toBeVisible({ timeout: 1620000 });
        ...
        await expect(grid).toBeVisible({ timeout: 3645000 });
    ...
    test('Verify Pattern Detection Suggestion', async ({ page }) => {
        ...
        await expect(page.getByText('Frequent Technical Installation')).toBeVisible({ timeout: 1620000 });
